import {
  isPlatformBrowser
} from "./chunk-S2MCTYJB.js";
import "./chunk-7P7GPYV3.js";
import {
  ...
  ɵɵqueryAdvance,
  ɵɵviewQuerySignal
} from "./chunk-R6ZXCRN7.js";
import "./chunk-PPN27ZOZ.js";
import {
  __name
...
var _ChartComponent = class _ChartComponent {
  ...
  hydrate(changes) {
    ...
    afterNextRender({
      read: /* @__PURE__ */ __name(() => this.createElement(), "read")
    }, {
  ...
  async createElement() {
    const {
      default: ApexCharts
    } = await import("./apexcharts.esm-ZZIULO5I.js");
